(function($){
    ...
    //show/ hide edit address popup
    $( "#addressOption1" ).click(function() {
        $("#openNewAddress").hide("slow");
    });

    $( "#addressOption2" ).click(function() {
        $("#openNewAddress").hide("slow");
    });

    $( "#addressOption3" ).click(function() {
        $("#openNewAddress").show("slow");
    });


    //show/ hide edit payment popup
    $( "#paymentOption1" ).click(function() {
        $("#openNewPayment").hide("slow");
    });
    ...
    $( "#paymentOption3" ).click(function() {
        $("#openNewPayment").show("slow");
    });



    //Only one checkbox opened at a time
    $('.address-option').click(function() {
      $('.address-option').not(this).prop('checked', false);
    });
